...
import org.usfirst.frc1939.KillerRabbit.subsystems.Shooter;
/**
 *
 */
public class  SpinWheels extends Command {
    ...
    protected void initialize() {
        alreadySpinning = Robot.shooter.isSpinning();
        Robot.shooter.spinWheels();
        this.setTimeout(Shooter.spinDelay);
    }
    ...
    protected boolean isFinished() {
        return this.isTimedOut() || alreadySpinning;
    }
